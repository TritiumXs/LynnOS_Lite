 ...
 * ================ IPC ================
 */
#define MAX_SIGNAL_NUMBER   64    // max number of allowed signal, [1,64]
#define MAX_PIPE_BUFFER     1023  // max size of a pipe buffer
#define MAX_PIPE_NUMBER     32    // max pipe number

#define MAX_MQ_NUMBER       LOSCFG_BASE_IPC_QUEUE_LIMIT  // max mqueue number
#define MAX_MQ_NAME_LEN     2560                         // max mqueue name length
#define MAX_MQ_MSG_SIZE     65530                        // max mqueue message size


/**
 * ================ FS ================
 */
#define MAX_PATH_SIZE  256      // max size of path string
