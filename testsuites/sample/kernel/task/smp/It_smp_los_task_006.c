...
static UINT32 Testcase(void)
{
    ...
    TEST_TASK_PARAM_INIT(task1, "it_smp_task_006", (TSK_ENTRY_FUNC)TaskF01, TASK_PRIO_TEST + 1);
    int i;
...
void ItSmpLosTask006(void)
{
    TEST_ADD_CASE("ItSmpLosTask006", Testcase, TEST_LOS, TEST_TASK, TEST_LEVEL1, TEST_FUNCTION);
}
